...
final class SonarAppStore: ObservableObject {
    private enum Keys {
        ...
        /// Reciprocal typing-indicator opt-in (default OFF): gates both
        /// sending local typing and displaying remote typing, Signal-style.
        static let typingIndicatorsEnabled = "sonar.typingIndicators.enabled"
